...
')
     ...
     */ 
         ...
         * 
         *
         * @see \Kiwilan\Steward\StewardServiceProvider::bootingPackage()
         * @param mixed $text
         * @static 
         */ 
     ...
     */ 
         ...
         * @static 
         */ 
        public static function throwErrors()
        {
                        /** @var \Kiwilan\Sentinel\Sentinel $instance */
                        return $instance->throwErrors();
        }
                    /**
         * 
         *
     ...
     */ 
        ...
        {
                        /** @var \Kiwilan\Steward\Steward $instance */
