...
<div class="grid grid-cols-1 gap-6 bg-gray-200 bg-opacity-25 p-6 dark:bg-gray-800 md:grid-cols-2 lg:gap-8 lg:p-8">
  <div>
    ...
    <p class="mt-4 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
      Laravel has wonderful documentation covering every aspect of the framework. Whether you're new to the framework or
    ...
    <p class="mt-4 text-sm">
      ...
      >
        ...
        <svg
          class="ml-1 h-5 w-5 fill-primary-500 dark:fill-primary-200"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
        >
          <path
  ...
  <div>
    ...
    <p class="mt-4 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
      ...
      You'll be amazed how easily you can build and maintain fresh, modern designs with this wonderful framework at your
      fingertips.
    </p>
  </div>
  ...
  <div>
    ...
    <p class="mt-4 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
      ...
      verification and resetting forgotten passwords. So, you're free to get started with what matters most: building
      your application.
    </p>
  </div>
</div>
